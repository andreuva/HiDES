...
# -------------- GRID PARAMETERS ----------------------------------------------
nintx = 128						# nintx number of intervals in the x direction
nintz = 128						# nintz number of intervals in the z direction
...
itmax = 64						# itmax maximum number of iterations
timef = 10						# timef maximum physical time
plt_cad = 2 ; str_cad = 1e4		# plot cadence, store cadence - cadence for output
...
boundcond = 'periodic'			# boundcond         : (allow 20 spaces) type of boundary conditions between: 'periodic' and '0deriv' ('periodic by default')
ondx = 1.; ondz = 0.			# ondx, ondz init   : number of wave in the x and z direcction ondx = kx = 2pim/Lx and angle of the paquet angle = atan(kz/kx)
...
cflparam = 0.90					# cflparam   parameter for the Courant condition
